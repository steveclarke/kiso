...
require "generators/kiso/framework_component/framework_component_generator"

class Kiso::Generators::FrameworkComponentGeneratorTest < Rails::Generators::TestCase
  tests Kiso::Generators::FrameworkComponentGenerator
  destination File.expand_path("../tmp", __dir__)

  setup do
    prepare_destination

    # Create kiso.gemspec marker so the safety guard passes
    FileUtils.touch(File.join(destination_root, "kiso.gemspec"))
